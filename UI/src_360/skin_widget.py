...
class SkinWidget(QWidget):
	def __init__(self, parent = None):
		...
		self.showSkin(str(self.current_page))	
	...
	def initBottom(self):
		...
		for i in range(self.page_count):
			...
			self.page_button.setText(str(i+1))
	...
	def showSkin(self, current_skin):	
		if(current_skin == "first"):		
			...
			self.current_page = int(current_skin)
		...
		'''
		self.change_skin_widget_0.changeSkin("./img/skin/"+ str(self.previous_total_page+1), self.tip_list[self.tip_index+1], "11")
		self.change_skin_widget_1.changeSkin("./img/skin/"+ str(self.previous_total_page+2), self.tip_list[self.tip_index+2], "11")
		self.change_skin_widget_2.changeSkin("./img/skin/"+ str(self.previous_total_page+3), self.tip_list[self.tip_index+3], "11")
		self.change_skin_widget_3.changeSkin("./img/skin/"+ str(self.previous_total_page+4), self.tip_list[self.tip_index+4], "11")
		self.change_skin_widget_4.changeSkin("./img/skin/"+ str(self.previous_total_page+5), self.tip_list[self.tip_index+5], "11")
		self.change_skin_widget_5.changeSkin("./img/skin/"+ str(self.previous_total_page+6), self.tip_list[self.tip_index+6], "11")
		self.change_skin_widget_6.changeSkin("./img/skin/"+ str(self.previous_total_page+7), self.tip_list[self.tip_index+7], "11")
		self.change_skin_widget_7.changeSkin("./img/skin/"+ str(self.previous_total_page+8), self.tip_list[self.tip_index+8], "11")
	...
	def paintEvent(self,event):
		...
		self.skin_name = str("./img/skin/17_big.png")
