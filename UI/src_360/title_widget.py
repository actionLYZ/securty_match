...
class TitleWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.skin_button.clicked.connect(Global.main_widget.showSkinWidget)
        self.min_button.clicked.connect(Global.main_widget.showMin)
        self.max_button.clicked.connect(Global.main_widget.showMax)
        self.close_button.clicked.connect(Global.main_widget.showClose)
        ...
        #工具栏图标列表
        string_list = ["./img/toolWidget/ruanJian.png","./img/toolWidget/qingLi.png", \
                       "./img/toolWidget/muMa.png","./img/toolWidget/menZhen.png"]
